...
#         self.table_widget.setColumnWidth(0, 100)  # Codice
#         self.table_widget.setColumnWidth(1, 60)   # Peso
#         self.table_widget.setColumnWidth(2, 60)   # Volume
#         self.table_widget.setColumnWidth(3, 120)  # Tipo
#         self.table_widget.setColumnWidth(4, 150)  # Metodo Pagamento
#         self.table_widget.setColumnWidth(5, 200)  # Mittente
#         self.table_widget.setColumnWidth(6, 200)  # Destinatario
#         self.table_widget.setColumnWidth(7, 100)  # Stato

#         # Adatta l'altezza delle righe al contenuto
...
#         self.setLayout(self.layout)
    ...
    # ... (metodi popola_tabella, aggiungi_riga, aggiungi_riga_collo, conferma_deposito rimangono invariati)