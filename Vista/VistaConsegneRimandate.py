...
class VistaConsegneRimandate(QWidget):
    def __init__(self, gestoreConsegna):
        ...
        self.resize(600, 250)
        self.setWindowTitle("Consegne rimandate")
        self.label = QLabel("Consegne standard rimandate:")
    ...
    def initUI(self):
        ...
        i = 0
        for consegnaAssegnata in self.gestoreConsegna.listaConsegneNegative:
            self.listaConsegneNegative.insertItem(i, f"Consegna n. {consegnaAssegnata.datiConsegna.codiceConsegna}")
            i+=1
