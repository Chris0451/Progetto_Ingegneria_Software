...
if __name__ == '__main__':
    ...
    # print (pacchiConsegne[0].datiConsegna.codiceConsegna)
    # pacchiRitiri = lettore.read_ritiri()
    # print (pacchiRitiri[0].datiRitiro.codiceRitiro)
    # colliRitiri = lettore.leggi_lista_colli()
    # print (colliRitiri[0].aziendaMittente.orarioApertura)
    # print(colliRitiri[0].datiRitiro.codiceRitiro)
    # colliConsegne = lettore.leggi_lista_colli_consegne()
    # print(colliConsegne[0].datiConsegna.codiceConsegna)
